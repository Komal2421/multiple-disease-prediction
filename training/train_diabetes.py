...
print("\n" + "="*60)
print("  DIABETES — Multi-Classifier Accuracy Comparison")
print("="*60)
...
joblib.dump(best_name,  "models/diabetes_best_model_name.pkl")

print(f"Saved '{best_name}' as models/diabetes_model.pkl")
print("Saved scaler as models/diabetes_scaler.pkl")